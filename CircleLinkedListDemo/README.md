...
![1567932796325](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567932796325.png)

单向循环链表是这样的，最后一个节点的next指向了链表中的第一个节点，与我们之前学习的环形链表比较相似

![1567932899631](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567932899631.png)
...
![1567933607309](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567933607309.png)
...
![1567935768645](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567935768645.png)
...
![1567936287138](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567936287138.png)

如果我们是往最后的位置添加该节点，则添加完成后的引用应该是这样的

![1567936769142](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567936769142.png)
...
![1567938152208](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567938152208.png)
...
![1567939060989](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567939060989.png)
...
![1567949993206](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567949993206.png)

将链表访问轨迹则为这样的、

![1567950090059](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567950090059.png)

串起来后，是这样的

![1567950135818](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567950135818.png)
...
![1567950359454](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567950359454.png)
...
![1567950718653](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567950718653.png)

**往最前面添加元素**

如果我们要再数组的首节点添加元素的话，也是对首元素进行操作，比如现在有以下数组

![1567951002495](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567951002495.png)

假设我们还要继续往数组的最前面插入元素，我们则可以通过在数组尾部添加，下图所示

![1567951132417](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567951132417.png)
...
![1567951728868](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567951728868.png)

以前的话，我们是将后面的所有元素，往后移动，但是引入了记录首元素位置后，我们可以选择移动元素较少的一边，如将上图中的22，33往前移动

![1567951912498](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567951912498.png)

然后就可以在空出来的地方，插入新的元素

![1567952014922](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567952014922.png)

**删除中间的元素**

与往中间添加元素相似，如果我们要删除中间的元素，也是选择元素较少的一方来进行元素移动

![1567952167732](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567952167732.png)

删除完成后

![1567952249000](C:\Users\T\AppData\Roaming\Typora\typora-user-images\1567952249000.png)
